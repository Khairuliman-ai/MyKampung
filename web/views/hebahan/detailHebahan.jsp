...
<div class="flex-1 overflow-y-auto p-4 md:p-8 bg-[#F7F7F9]">
    <div class="max-w-4xl mx-auto">
        <button onclick="history.back()" class="flex items-center gap-2 text-gray-500 hover:text-[#6C5DD3] mb-6 transition font-medium">
        ...
        <div class="bg-white rounded-[40px] shadow-sm border border-gray-100 overflow-hidden">
            ...
            <% } else { %>
            <div class="w-full h-48 bg-gradient-to-r from-[#6C5DD3] to-[#A297E8] flex items-center justify-center">
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="bg-gray-50 rounded-3xl p-6">
                            ...
                            <div class="space-y-4">
                                <div class="flex gap-3">
                                    <div class="w-8 h-8 rounded-xl bg-white flex items-center justify-center text-[#6C5DD3] shadow-sm">
                        ...
                        <div class="px-6">
                            ...
                            <div class="flex items-center gap-3">
                                <div class="w-10 h-10 rounded-full bg-[#6C5DD3] flex items-center justify-center text-white font-bold">
