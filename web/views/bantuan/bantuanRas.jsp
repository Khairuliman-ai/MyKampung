                ...
                <div id="editBankSection" class="hidden space-y-6 pt-6 border-t border-dashed border-gray-200">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div class="space-y-2">
                            ...
                            <input type="text" name="namaBank" id="editNamaBank"
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="text" name="nomorAkaun" id="editNomorAkaun"
...
<script>
    ...
    function confirmDelete(event, url) {
        ...
        Swal.fire({
            ...
            text: "Adakah anda pasti mahu memadam permohonan ini? Tindakan ini tidak boleh diundurkan.",
            icon: 'warning',
