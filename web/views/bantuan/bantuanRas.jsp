                        ...
                        <table class="table" id="tableProses">
                            ...
                            <tbody>
                                ...
                                <tr class="data-row" data-date="<%= filterDate%>" data-status="<%= pb.getStatus()%>">
                                    ...
                                    <td class="fw-bold text-success search-col">
                                        <%= pb.getNamaBantuan()%>
                                    </td>

                                    <td>
                                        <% if (pb.getDokumen() != null) {
                    String enc = URLEncoder.encode(pb.getDokumen(), "UTF-8").replace("+", "%20");%>
            ...
            <div class="mb-5">
                ...
                <div class="ecstatic-card">
                        ...
                        <table class="table" id="tableSejarah">
                            ...
                            <tbody>
                                ...
                                <tr class="data-row text-muted" data-date="<%= filterDate%>" data-status="<%= pb.getStatus()%>">
                                    ...
                                    <td class="fw-bold search-col text-dark">
                                        <%= pb.getNamaBantuan()%>
                                    </td>
                    ...
                    String enc = URLEncoder.encode(pb.getDokumenBalik(), "UTF-8").replace("+", "%20");%>
                                        <a href="<%= request.getContextPath()%>/file/<%= enc%>" class="btn btn-sm btn-outline-success rounded-pill fw-bold" target="_blank"><i class="bi bi-download me-1"></i> PDF</a>
        ...
        <script>
            ...
            function filterData() {
                ...
                rows.forEach(row => {
                    ...
                    // 3. Tapis Teks
                    if (searchVal !== "" && !textContent.includes(searchVal))
                        showRow = false;
