    ...
    <div class="max-w-7xl mx-auto">
        ...
        <header class="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
            ...
            <div class="relative w-full md:w-80 group">
                <span class="absolute inset-y-0 left-0 pl-4 flex items-center text-gray-400 group-focus-within:text-slate-600 transition-colors">
                    <i class="fas fa-search"></i>
                </span>
                <input type="text" 
                       class="w-full pl-11 pr-4 py-3 bg-white rounded-2xl border border-slate-200 focus:ring-4 focus:ring-slate-100 focus:border-slate-400 shadow-sm text-sm placeholder-gray-400 transition-all outline-none" 
                       placeholder="Cari permohonan atau rekod...">
            </div>
        </header>
