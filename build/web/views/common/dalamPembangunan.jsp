...
<div class="flex-1 overflow-y-auto p-8 scroll-smooth h-full bg-[#F7F7F9] flex flex-col justify-center items-center text-center">
    ...
    <div class="bg-white p-10 rounded-3xl shadow-sm border border-gray-100 max-w-lg w-full relative overflow-hidden">
        ...
        <div class="absolute top-0 right-0 -mr-16 -mt-16 w-40 h-40 bg-brand-accent rounded-full blur-2xl"></div>
        <div class="absolute bottom-0 left-0 -ml-16 -mb-16 w-40 h-40 bg-blue-50 rounded-full blur-2xl"></div>

        <div class="relative z-10">
            <div class="w-24 h-24 bg-brand-accent rounded-full flex items-center justify-center mx-auto mb-6">
                <i class="fas fa-tools text-4xl text-brand-purple"></i>
            </div>
            ...
            <a href="<%= request.getContextPath() %>/DashboardServlet" class="inline-flex items-center justify-center px-6 py-3 bg-brand-purple hover:bg-brand-purpleHover text-white font-bold rounded-xl transition shadow-md gap-2">
